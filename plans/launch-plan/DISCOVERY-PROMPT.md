# Project Discovery Prompt — Safetrekr Marketing Site Launch
...
> - Input signals: See Section 1 below
...
Output Directory:     plans/launch-plan
Input Signal(s):

  1. plans/launch-plan/initial-thoughts/product-review-safetrekr-app-v2-verified.md
     (Code-verified product capabilities — the authoritative source for what
     Safetrekr actually does. Verified against 3 codebases: safetrekr-app-v2,
     safetrekr-core, native-mobile-app.)

  2. plans/launch-plan/intitial-reviews/holistic-overview.md
     (Synthesized plan from 10 specialist reviews — the authoritative source
     for what the marketing site should become. Includes visual identity
     directive, site architecture, messaging framework, risk register.)

  3. plans/launch-plan/intitial-reviews/*.md (10 individual specialist reviews):
     - chief-technology-architect.md     — Capsule mapping, 82% codebase reuse, file inventory
     - enterprise-pm-pmo.md             — 3-phase plan, risk register, hybrid ZUI approach
     - software-product-owner.md        — 4 personas, acceptance criteria, pricing psychology
     - autonomous-interface-architect.md — 6-card ring geometry, morph specs, responsive breakpoints
     - digital-marketing-lead.md        — SEO strategy, sitemap, structured data, 8-week plan
     - product-narrative-strategist.md   — "Calm Authority" voice, draft headlines, objection handling
     - product-strategy-analyst.md       — $2.4-3.2B TAM, zero competitors, vertical-led GTM
     - ui-designer.md                   — Oblivion HUD aesthetic, glass-morphism, typography system
     - ux-designer.md                   — Hybrid approach, mobile-first, WCAG audit, research plan
     - protective-operations-expert.md   — Independent analyst review = killer feature, trust language

Read ALL input signals before starting Phase 1. The holistic-overview.md
synthesizes the 10 reviews — start there, then reference individual reviews
for depth on specific topics.

────────────────────────────────────────────────────────────────────────────────
1b. PROJECT CONTEXT (Non-Negotiable Constraints)
────────────────────────────────────────────────────────────────────────────────

VISUAL IDENTITY: Oblivion (2013) HUD / Mission-Control Aesthetic
  - Dark backgrounds (#061A23 → #0A2A38 → #365462), green primary (#4BA467)
  - Glass-morphism cards, breathing glow CTAs, ambient effects (particles, scanlines)
  ...
  - See CLAUDE.md "Visual Identity" section for full specification
...
KILLER DIFFERENTIATOR: Independent safety analyst review
  - No competitor offers this. Separation of duties is non-negotiable for
    credible safety operations. Every page connects back to this feature.
...
TARGET AUDIENCE: Security directors, safety officers, risk managers
  ...
  - They care about accountability and documentation, not visual novelty

ARCHITECTURE DECISION: Hybrid approach
  - Traditional landing page at / (hero + value props + CTA)
  - Spatial ZUI at /launch as optional "Explore the Platform"
  - Content pages (/how-it-works, /platform, /solutions, /pricing, /security)
    are server-rendered Next.js pages for SEO

TECH STACK: Next.js 16, pnpm (never npm), motion/react (never framer-motion),
  Zustand 5 + Immer, Tailwind CSS v4, Supabase backend
...
MANDATORY PRODUCT OWNER CONSULTATION (STANDARD and DEEP):
  Spawn Task (subagent_type: software-product-owner):
    "I'm conducting project discovery for Safetrekr Marketing Site Launch.
...
Produce exactly TWO files in plans/launch-plan:

╔══════════════════════════════════════════════════════════════════════════════╗
║  DELIVERABLE 1: combined-recommendations.md                                ║
╚══════════════════════════════════════════════════════════════════════════════╝

File: plans/launch-plan/combined-recommendations.md
...
File: plans/launch-plan/agent-roster.md
...
Create a file: plans/launch-plan/DISCOVERY-LOG.md at the start of
...
AT SESSION START:
  1. Read plans/launch-plan/DISCOVERY-LOG.md
  2. Search memory MCP for prior findings:
     mcp__memory__search_nodes with query: "Safetrekr Marketing Site Launch discovery"
...
You have READ permission on:
  - /Users/jessetarvambp1/Sites/Safetrekr/marketing-site-2 (explore freely, read any file)
  - Any referenced documentation, configs, or schemas

You have WRITE permission on:
  - plans/launch-plan (for the two deliverables + DISCOVERY-LOG.md)
...
1. Read the Input Signal(s) listed in Section 1 above (start with holistic-overview.md)
