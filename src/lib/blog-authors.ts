...
export const AUTHORS: Record<string, BlogAuthor> = {
  'mike-dawson': {
    ...
    avatar: `${BASE_PATH}/images/authors/mike-dawson.jpg`,
  ...
  'alan-d': {
    ...
    avatar: `${BASE_PATH}/images/authors/alan-d.jpg`,
  ...
  'bobby-brasher': {
    ...
    avatar: `${BASE_PATH}/images/authors/bobby-brasher.jpg`,
  ...
  'safetrekr-team': {
    ...
    name: 'Safetrekr Team',
    role: 'Safetrekr',
    avatar: `${BASE_PATH}/images/logos/safetrekr-mark-dark.svg`,
